...
const Footer = () => {
    return (
        <footer className="container mx-auto mt-24 p-6 bg-green-100 text-black">
            <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
                ...
                <div className="flex flex-col space-y-4">
                    <h2 className="font-medium">Reach me</h2>
                    <div className="flex flex-col space-y-2 text-sm text-gray-600">
                        <a rel="noopener noreferrer" href="#">About </a>
                        <a rel="noopener noreferrer" href="#">Site</a>
                        <a rel="noopener noreferrer" href="#">Map Brand</a>
